//
//  UIView+UIViewAdditionsExt.m
//  UCUIKit
//
//  Created by mac on 16/1/9.
//  Copyright © 2016年 samuelyang. All rights reserved.
//

#import "UIViewAdditionsExt.h"

@implementation UIView (UIViewAdditionsExt)
...
{
	NSAssert(self.superview, @"not superView!");
	[self setSuperViewWidthCenter];
	[self setSuperViewHeightCenter];
}
